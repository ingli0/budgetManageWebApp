from .views import RegistrationView,UsernameValdationView, EmailValdationView,VerificationView,LoginView,LogoutView,RequestPasswordResetEmail,CompletePasswordReset
